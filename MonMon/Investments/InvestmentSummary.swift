...
enum InvestmentSummary {
    ...
    static func total(deposits: [SavingsDeposit], holdings: [FundHolding]) -> Decimal {
        AssetSummary.totalPrincipal(of: deposits) + FundSummary.totalMarketValue(of: holdings)
    }
}
