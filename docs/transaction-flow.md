...
Add Transaction handles horizontal swipes at the shared entry-content container, so Income, Expense and Transfer all follow the same tab order. Vertical and short drags do not switch tabs; drafts remain owned by the screen.
